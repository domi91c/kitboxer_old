      ...
      var s = $(r), // input element
          ...
          f = {
            ...
            init: function() {
              ...
              if (n.beforeRender && $.isFunction(n.beforeRender) &&
              ...
              f.rendered = true;
              n.afterRender && $.isFunction(n.afterRender) ? n.afterRender(l, p,
                  o, s) : null;
            ...
            bindUnbindEvents: function(bind) {
              ...
              if (n.dragDrop && n.dragDrop.container.length) {
                ...
                n.dragDrop.container[bind ? 'on' : 'off']('drop',
                    f.dragDrop.onDrop);
                n.dragDrop.container[bind ? 'on' : 'off']('dragover',
                    f.dragDrop.onDragEnter);
                n.dragDrop.container[bind ? 'on' : 'off']('dragleave',
              ...
              // bind the form resetFileInput
              s.closest('form')[bind ? 'on' : 'off']('reset', f.resetFileInput);
            },
            ...
            set: function(type, value) {
              switch (type) {
                case 'attrOpts':
                  ...
                  for (var k = 0; k < d.length; k++) {
                    ...
                    if (f._assets.hasAttr(j)) {
                      switch (d[k]) {
                        ...
                        case 'addMore':
                        case 'listInput':
                          n[d[k]] = (['true', 'false'].indexOf(s.attr(j)) > -1
                              ? s.attr(j) == 'true'
                              : s.attr(j));
                          break;
                        case 'extensions':
                  ...
                  if (s.attr('disabled') != null ||
                      s.attr('readonly') != null || n.limit === 0) {
                    f.disabled = true;
                  }
                  ...
                  if (n.listInput === true) {
                    n.listInput = $(
                        ...
                        s.attr('name').
                            ...
                            split('[').
                            pop().
                            replace(']', '') + '">').insertBefore(s);
                  }
                  if (typeof n.listInput == 'string' &&
                ...
                case 'feedback':
                  if (!value) {
                    value = f._assets.textParse(f._itFl.length > 0
                        ? n.captions.feedback2
                        : n.captions.feedback, {length: f._itFl.length});
                  }

                  $(!o.is(':file')) ? o.find(
                      '.fileuploader-input-caption span').html(value) : null;
                  break;
                  // set file input value to empty
                case 'input':
                  var el = f._assets.copyAllAttributes($('<input type="file">'),
                      s, true);
                ...
                case 'listInput':
                  if (n.listInput) {
                    n.listInput.val(
                        value === null ? f.files.list(true) : value);
                  }
                  break;
              }
            },
            ...
            onChange: function(e, fileList) {
              ...
              // resetFileInput the input if default mode
              if (f.isDefaultMode()) {
                f.resetFileInput();
              ...
              if (n.beforeSelect && $.isFunction(n.beforeSelect) &&
              ...
              for (var i = 0; i < files.length; i++) {
                ...
                // onSelect callback
                n.onSelect && $.isFunction(n.onSelect) ? n.onSelect(item, l, p,
                    o, s) : null;
              ...
              n.afterSelect && $.isFunction(n.afterSelect) ? n.afterSelect(l, p,
                  o, s) : null;
            },
            ...
            thumbnails: {
              ...
              create: function() {
                ...
                $.isFunction(n.thumbnails.beforeShow) ? n.thumbnails.beforeShow(
                    p, o, s) : null;

                // create item's list element
                var box = $(f._assets.textParse(n.thumbnails.box)).
                    appendTo(n.thumbnails.boxAppendTo
                        ? n.thumbnails.boxAppendTo
                        : p);
                l = !box.is(n.thumbnails._selectors.list) ? box.find(
                    n.thumbnails._selectors.list) : box;
                    ...
                    if (item) {
                      if (item.upload && item.upload.status != 'successful') {
                        ...
                        if (n.thumbnails.removeConfirmation) {
                          n.dialogs.confirm(
                              f._assets.textParse(n.captions.removeConfirmation,
                                  item), c);
                        } else {
                          c();
                        }
               ...
               */
              item: function(item) {
                item.icon = f.thumbnails.generateFileIcon(item.format,
                    item.extension);
                ...
                $.isFunction(n.thumbnails.onItemShow) ? n.thumbnails.onItemShow(
                    item, l, p, o, s) : null;
              },
              /**
               * generateFileIcon
              ...
              generateFileIcon: function(format, extension) {
                var el = '<div style="${style}" class="fileuploader-item-icon' +
                    '${class}"><i>' + (extension ? extension : '') +
                    '</i></div>';
              ...
              renderImage: function(item, force_render) {
                ...
                if (item.format == 'image' && f.isFileReaderSupported() &&
                    (item.appended || n.thumbnails.startImageRenderer ||
                    force_render)) {

                  // check pending list
                  if (n.thumbnails.synchronImages) {
                    f._pfrL.indexOf(item) == -1 && !force_render ? f._pfrL.push(
                        item) : null;
                        ...
                        if (n.thumbnails.canvasImage) {
                          ...
                          img.onload = function() {
                            ...
                            if (img.width < canvas.width ||
                                img.height < canvas.height || steps <= 1) {
                              var x = img.width < canvas.width
                              ...
                              octx.drawImage(oc, 0, 0, oc.width * 0.5,
                                  oc.height * 0.5);

                              context.drawImage(oc,
                                  optimalWidth > canvas.width ? optimalWidth -
                                      canvas.width : 0, 0, oc.width * 0.5,
                                  oc.height * 0.5, 0, 0, optimalWidth,
                                  optimalHeight);
                            }
                          ...
                          setImageThumb('<img src="' + e.target.result +
                              '" draggable="false">');
                        }
                      };
            ...
            upload: {
              ...
              prepare: function(item, force_send) {
                ...
                item.upload.formData.append(s.attr('name'), item.file,
              ...
              send: function(item, force_send) {
                ...
                var setItemUploadStatus = function(status) {
                    ...
                    loadNextItem = function() {
                      ...
                      if (f._pfuL.length > 0) {
                        f._pfuL.indexOf(item) > -1 ? f._pfuL.splice(
                            f._pfuL.indexOf(item), 1) : null;
                        while (i < f._pfuL.length) {
                          if (f._itFl.indexOf(f._pfuL[i]) > -1 &&
                              f._pfuL[i].upload && !f._pfuL[i].upload.$ajax) {
                ...
                if (n.upload.beforeSend && $.isFunction(n.upload.beforeSend) &&
                ...
                item.upload.success = function(data, textStatus, jqXHR) {
                  ...
                  n.upload.onSuccess != null && $.isFunction(n.upload.onSuccess)
                      ? n.upload.onSuccess(data, item, l, p, o, s, textStatus,
                      jqXHR)
                      : null;
                };
                item.upload.error = function(jqXHR, textStatus, errorThrown) {
                  item.uploaded = false;
                  item.upload.status = item.upload.status == 'cancelled'
                      ? item.upload.status
                      : 'failed';
                  delete item.upload.$ajax;
                  ...
                  n.upload.onError != null && $.isFunction(n.upload.onError)
                      ? n.upload.onError(item, l, p, o, s, jqXHR, textStatus,
                      errorThrown)
                      : null;
                };
                ...
                if (e.lengthComputable) {
                  var loaded = e.loaded,
                      ...
                      secondsElapsed = (new Date().getTime() -
                          xhrStartedAt.getTime()) / 1000,
                      bytesPerSecond = secondsElapsed
                          ? loaded / secondsElapsed
                          : 0,
                      remainingBytes = total - loaded,
                      secondsRemaining = secondsElapsed ? remainingBytes /
                          bytesPerSecond : null,
                      data = {
                        loaded: loaded,
                        ...
                        bytesPerSecondInFormat: f._assets.bytesToText(
                            bytesPerSecond) + '/s',
            ...
            dragDrop: {
              ...
              onDragEnter: function(e) {
                ...
                $.isFunction(n.dragDrop.onDragEnter) ? n.dragDrop.onDragEnter(e,
                    l, p, o, s) : null;
              },
              /**
               * onDragLeave
              ...
              onDragLeave: function(e) {
                ...
                f.dragDrop._timer = setTimeout(function(e) {
                  ...
                  $.isFunction(n.dragDrop.onDragLeave) ? n.dragDrop.onDragLeave(
                      e, l, p, o, s) : null;
                }, 100, e);
              },
              /**
                ...
                for (var i = 0; i < items.length; i++) {
                  if (items[i].type.indexOf('image') !== -1 ||
                    ...
                    if (blob) {
                      ...
                      blob._name = 'Clipboard ' + date.getFullYear() + '-' +
                          addZero(date.getMonth() + 1) + '-' +
                          addZero(date.getDate()) + ' ' +
                          addZero(date.getHours()) + '-' +
                          addZero(date.getMinutes()) + '-' +
                          addZero(date.getSeconds());
                      blob._name += blob.type.indexOf('/') != -1
                          ? '.' +
            ...
            files: {
              ...
              add: function(file, prop) {
                var name = file.name,
                    ...
                    extension = name.indexOf('.') != -1 ? name.split('.').
                        pop().
                        toLowerCase() : '',
                    title = name.substr(0, name.length -
                        (name.indexOf('.') != -1
                            ? extension.length + 1
                            : extension.length)),
                    data = file.data,
              ...
              list: function(toJson, customKey, triggered) {
                ...
                files = n.onListInput && $.isFunction(n.onListInput) &&
                !triggered
              ...
              check: function(item, files, fullCheck) {
                ...
                if (n.onFilesCheck != null && $.isFunction(n.onFilesCheck) &&
                    fullCheck) {
                ...
                if (item.size == 4096 && item.type == '') {
                  r[1] = f._assets.textParse(n.captions.errors.folderUpload,
                      item);
                  return r;
                }
                if (/*!f.isDefaultMode()*/true) {
                  ...
                  $.each(f._itFl, function(i, a) {
                    if (a != item && a.choosed == true && a.file &&
                        a.file.name == item.name) {
                      g = true;

                      if (a.file.size == item.size &&
                        ...
                        r[1] = f._assets.textParse(n.captions.errors.fileName,
                            item);
                        r[2] = false;
                      }
              ...
              append: function(files) {
                ...
                if (files.length) {
                  ...
                  // afterSelect callback
                  n.afterSelect && $.isFunction(n.afterSelect) ? n.afterSelect(
                      l, p, o, s) : null;
              ...
              remove: function(item, isFromCheck) {
                // onRemove callback
                if (!isFromCheck && n.onRemove && $.isFunction(n.onRemove) &&
                ...
                if (item.html) {
                  ...
                  $.isFunction(n.thumbnails.onItemRemove) && !isFromCheck
                ...
                f._pfrL.indexOf(item) > -1 ? f._pfrL.splice(
                    f._pfrL.indexOf(item), 1) : null;
                f._pfuL.indexOf(item) > -1 ? f._pfuL.splice(
                    f._pfuL.indexOf(item), 1) : null;
                f._itFl.indexOf(item) > -1 ? f._itFl.splice(
                    f._itFl.indexOf(item), 1) : null;
                item = null;

                // resetFileInput the plugin if there are no any files in the memory
                f._itFl.length == 0 ? f.resetFileInput() : null;
                ...
                if (item) {
                  if (typeof item[attr] != 'undefined') {
                    result = item[attr];
                      ...
                      typeof item.data[attr] != 'undefined') {
            ...
            /**
             * resetFileInput
             * resetFileInput the plugin
             *
             * @param {bool} all - remove also appended files?
             * @void
             */
            resetFileInput: function(all) {
              if (all) {
                if (f.clipboard._timer) {
                  f.clipboard.clean();
                }
            ...
            _assets: {
              ...
              secondsToText: function(seconds, textFormat) {
                ...
                if (minutes > 0 || !textFormat) {
                  result += (minutes < 10 && !textFormat ? '0' : '') + minutes +
                      (textFormat ? 'm ' : ':');
                }

                result += (seconds < 10 && !textFormat ? '0' : '') + seconds +
                    (textFormat ? 's' : '');
                ...
                switch (typeof(text)) {
                  case 'string':
                    text = text.replace(/\$\{(.*?)\}/g, function(match, a) {
                      var a = a.replace(/ /g, ''),
                          r = typeof opts[a] != 'undefined' && opts[a] != null
                              ? opts[a]
                              : '';

                      if (a.indexOf('.') > -1 || a.indexOf('[]') > -1) {
                        var x = a.substr(0,
                            a.indexOf('.') > -1 ? a.indexOf('.') : a.indexOf(
                                '[') > -1 ? a.indexOf('[') : a.length),
              ...
              textToColor: function(str) {
                ...
                for (var i = 0, hash = 0; i < str.length; hash = str.charCodeAt(
                        i++) + ((hash << 5) - hash)) {
                  ;
                }
                for (var i = 0, colour = '#'; i < 3; colour += ('00' +
                ((hash >> i++ * 2) & 0xFF).toString(16)).slice(-2)) {
                  ;
                }
                return colour;
              },
              isBrightColor: function(color) {
                var getRGB = function(b) {
                      ...
                      if (a = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/.exec(
                              b)) {
                        return [
                          parseInt(a[1]),
                          parseInt(a[2]),
                      ...
                      if (a = /rgb\(\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*,\s*([0-9]+(?:\.[0-9]+)?)\%\s*\)/.exec(
                              b)) {
                        return [
                          parseFloat(a[1]) * 2.55,
                          parseFloat(a[2]) * 2.55,
                      ...
                      if (a = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(
                              b)) {
                        return [
                          parseInt(a[1], 16), parseInt(a[2], 16), parseInt(a[3],
                              16)];
                      }
                      if (a = /#([a-fA-F0-9])([a-fA-F0-9])([a-fA-F0-9])/.exec(
                              b)) {
                        return [
                          parseInt(a[1] + a[1], 16),
                          parseInt(a[2] + a[2], 16),
    ...
    captions: {
      ...
      feedback2: function(options) {
        return options.length + ' ' +
            (options.length > 1 ? ' files were' : ' file was') + ' chosen';
      },
